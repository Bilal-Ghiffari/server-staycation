...
seeder.connect('mongodb+srv://codeathome:Ghiffari_Al10@cluster0.3cqax.mongodb.net/db_staycation?retryWrites=true&w=majority', {
  ...
  seeder.clearModels(['Category', 'Bank', 'Item', 'Member', 'Item', 'Feature', 'Image', 'Booking', 'Users'], function () {
    ...
    //Panggilan balik untuk mengisi DB setelah koleksi dihapus
